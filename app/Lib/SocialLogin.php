...
class SocialLogin {
    ...
    private function configuration() {
        ...
        Config::set('services.' . $provider, [
            ...
            'redirect'      => $this->resolveCallbackUrl($provider),
        ]);
    }

    private function resolveCallbackUrl(string $provider): string {
        if (Route::has('user.social.callback')) {
            return route('user.social.callback', ['provider' => $provider]);
        }

        return route('user.social.login.callback', $provider);
    }
