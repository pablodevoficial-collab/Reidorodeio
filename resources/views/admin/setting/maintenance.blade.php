                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <div class="form-group">
                        <label>Status</label>
                        <input type="checkbox" data-width="100%" data-height="50" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-on="Enable" data-off="Desativado" @if(@gs('maintenance_mode')) checked @endif name="status">
                      </div>
                    </div>
                  </div>
                  <div class="row">
