                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control" name="paginate_number" data-minimum-results-for-search="-1">
                                        <option value="20" @selected(gs('paginate_number') == 20)>20 items per page</option>
                                        <option value="50" @selected(gs('paginate_number') == 50)>50 items per page</option>
                                        <option value="100" @selected(gs('paginate_number') == 100)>100 items per page</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="form-group ">
                                    ...
                                    <select class="select2 form-control" name="currency_format" data-minimum-results-for-search="-1">
                                        <option value="1" @selected(gs('currency_format') == Status::CUR_BOTH)>Show Currency Text and Symbol Both</option>
                                        <option value="2" @selected(gs('currency_format') == Status::CUR_TEXT)>Show Currency Text Only</option>
                                        <option value="3" @selected(gs('currency_format') == Status::CUR_SYM)>Show Currency Symbol Only</option>
                                    </select>
                                </div>
                            </div>
                        </div>
