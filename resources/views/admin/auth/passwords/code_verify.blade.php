        ...
        <div class="container custom-container d-flex justify-content-center">
            <div class="login-area">
                <div class="text-center mb-3">
                    <h2 class="text-white mb-2">Verificar Código</h2>
                    <p class="text-white mb-2">Verifique seu e-mail e digite o código de verificação que você recebeu.</p>
                </div>
                <form action="{{ route('admin.password.verify.code') }}" method="POST" class="login-form w-100">
                    ...
                    <div class="code-box-wrapper d-flex w-100">
                        <div class="form-group mb-3 flex-fill">
                            <span class="text-white">Código de verificação</span>
                    ...
                    <button type="submit" class="btn cmn-btn w-100">Enviar</button>
                    <div class="d-flex flex-wrap justify-content-between mt-3">
                        <a href="{{ route('admin.password.reset') }}" class="forget-text">Tentar enviar novamente</a>
                        <a href="{{ route('admin.login') }}" class="text-white"><i class="las la-sign-in-alt"></i>Voltar para o Login</a>
                    </div>
                </form>
            </div>
        </div>
