...
@section('panel')
    ...
    <div class="row mb-none-30">
        ...
        <div class="col-xl-9 col-lg-8 mb-30">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title mb-4 border-bottom pb-2">Perfil Information</h5>
...
@push('breadcrumb-plugins')
    <a href="{{route('admin.password')}}" class="btn btn-sm btn-outline--primary"><i class="las la-key"></i>Senha Setting</a>
@endpush
@push('style')
    <style>
