...
@section('panel')
    ...
    <div class="fantasy-create-wrapper">
        <div class="fantasy-create-card">
            <div class="fantasy-create-header">
                <h5><i class="las la-trophy"></i> @lang('Criar Nova Fantasy League')</h5>
            </div>

            <form method="post" action="{{ route('admin.fantasy_leagues.store') }}" enctype="multipart/form-data" id="fantasyLeagueCreateForm">
                @csrf
                ...
                <div class="fantasy-create-body">
                        ...
                        <div class="row">
                                ...
                                <div class="fantasy-form-group">
                                    ...
                                    <select name="rodeio_id" id="rodeio_id" class="fantasy-form-control" required>
                                        ...
                                        @foreach(($rodeios ?? []) as $r)
                                            <option value="{{ $r->id }}" @selected(old('rodeio_id') == $r->id)>{{ $r->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                    ...
                                    <select name="modalidade_id" id="modalidade_id" class="fantasy-form-control" required>
                                        ...
                                        @foreach(($modalidades ?? []) as $m)
                                            <option value="{{ $m->id }}"
                                                ...
                                                @selected(old('modalidade_id') == $m->id)
                                            >{{ $m->nome }}</option>
                                        @endforeach
                                    </select>
                                    <small class="fantasy-form-help"><i class="las la-link"></i> @lang('Todo bolão fica vinculado a uma modalidade específica deste rodeio.')</small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6" id="divisao_wrap" style="display:none;">
                                <div class="fantasy-form-group">
                                    ...
                                    <small class="fantasy-form-help"><i class="las la-info-circle"></i> @lang('Apenas se a modalidade possuir divisões')</small>
                                </div>
                            </div>

                            <div class="col-12">
                                <div class="fantasy-context-card" id="fantasyContextCard">
                                    <div class="fantasy-context-card__title">@lang('Contexto do bolão')</div>
                            ...
                            <div class="col-md-6">
                                <div class="fantasy-form-group">
                                    <label><i class="las la-tag"></i> @lang('Nome do bolão')</label>
                                    <input type="text" name="name" value="{{ old('name') }}" class="fantasy-form-control" placeholder="Ex: Copa Elite 2026" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="fantasy-form-group">
                                    ...
                                    <input type="text" name="category" value="{{ old('category') }}" class="fantasy-form-control" placeholder="Ex: ouro, prata, bronze" required>
                                ...
                                <div class="fantasy-form-group">
                                    ...
                                    <select name="organizer_sponsor_id" class="fantasy-form-control">
                                        ...
                                        @foreach(($sponsors ?? []) as $sponsor)
                                            <option value="{{ $sponsor->id }}" @selected(old('organizer_sponsor_id') == $sponsor->id)>{{ $sponsor->name }}</option>
                                        @endforeach
                                    </select>
                                    <small class="fantasy-form-help"><i class="las la-info-circle"></i> @lang('Se definido, a logo do patrocinador aparece no card deste bolão na arena.')</small>
                                </div>
                            </div>
                                    ...
                                    <div class="fantasy-context-card">
                                        ...
                                        <div class="fantasy-context-card__chips">
                                            <div class="fantasy-context-chip" style="min-width: 100%;">
                                                <span class="fantasy-context-chip__value">@lang('O bolão usará sempre a logo atual do rodeio selecionado.')</span>
                                            </div>
                                        </div>
                                    </div>
                                    <small class="fantasy-form-help"><i class="las la-info-circle"></i> @lang('Não existe mais upload manual de imagem para bolão.')</small>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="fantasy-section">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="fantasy-form-group">
                                    ...
                                    @php
                                        ...
                                        if (!$oldMode) {
                                            $oldMode = old('is_premium') ? 'premium' : (string) floatval(old('price', 20));
                                        }
                            ...
                            <div class="col-md-3">
                                <div class="fantasy-form-group">
                                    ...
                                    <input type="number" name="house_cut_percent" id="house_cut_percent" value="{{ old('house_cut_percent', 30) }}" step="0.01" min="0" max="50" class="fantasy-form-control">
                                    <small class="fantasy-form-help" id="house_cut_help"><i class="las la-info-circle"></i> @lang('Entre 20% e 50%')</small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="fantasy-form-group">
                                    ...
                                    <input type="number" name="max_users" id="max_users_input" value="{{ old('max_users') }}" min="1" class="fantasy-form-control" placeholder="Ilimitado">
                            ...
                            <div class="col-md-3">
                                <div class="fantasy-form-group">
                                    ...
                                    <input type="number" name="paid_positions_override" id="paid_positions_override_input" value="{{ old('paid_positions_override') }}" min="1" class="fantasy-form-control" placeholder="Automático">
                            ...
                            <div class="col-md-3">
                                <div class="fantasy-form-group">
                                    ...
                                    <input type="datetime-local" name="closes_at" value="{{ old('closes_at') ? \Carbon\Carbon::parse(old('closes_at'))->format('Y-m-d\TH:i') : '' }}" class="fantasy-form-control">
                                    <small class="fantasy-form-help"><i class="las la-info-circle"></i> @lang('Deixe vazio = aberto')</small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="fantasy-form-group">
                                    <label><i class="las la-hourglass-half"></i> @lang('Deadline de Inscrições')</label>
                                    <input type="datetime-local" name="registration_deadline" value="{{ old('registration_deadline') ? \Carbon\Carbon::parse(old('registration_deadline'))->format('Y-m-d\TH:i') : '' }}" class="fantasy-form-control">
                            ...
                            <div class="col-md-3">
                                <div class="fantasy-form-group">
                                    <label><i class="las la-unlock"></i> @lang('Inscrições Tardias')</label>
                                    <div class="form-check form-switch mt-2">
                                        ...
                                        <input type="checkbox" name="allow_late_registration" value="1" id="allow_late_registration"
                                            class="form-check-input" @checked(old('allow_late_registration'))>
                                        <label class="form-check-label" for="allow_late_registration">
                                            @lang('Ignorar deadline')
                                        </label>
                                    </div>
                                    <small class="fantasy-form-help text-warning"><i class="las la-exclamation-triangle"></i> @lang('Compromete fairness')</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="prize-calculation-card" id="prizeCalculationCard" style="display:none;">
                            ...
                            <input type="hidden" name="total_prize" id="total_prize_input" value="0">
                        </div>
                        
                        <!-- Simulador de Distribuição de Prêmios -->
                        ...
                        <input type="hidden" name="prize_distribution" id="prize_distribution_input" value="{{ old('prize_distribution', '') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6" id="prize_type_wrap" style="display:none;">
                                <div class="fantasy-form-group">
                                    ...
                                    @php
                                        $prizeType = old('prize_type', 'money');
                                    @endphp
                            ...
                            <div class="col-md-6" id="premium_prize_wrap" style="display:none;">
                                <div class="fantasy-form-group">
                                    ...
                                    <input type="number" name="manual_prize_pool" id="manual_prize_pool" value="{{ old('manual_prize_pool') }}" step="0.01" min="0" class="fantasy-form-control" placeholder="0,00">
                            ...
                            <div class="col-md-12" id="prize_description_wrap" style="display:none;">
                                <div class="fantasy-form-group">
                                    ...
                                    <textarea name="prize_description" id="prize_description" rows="2" maxlength="500" class="fantasy-form-control" placeholder="Ex: Top 5 com premios fisicos exclusivos">{{ old('prize_description') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="fantasy-form-group">
                                    ...
                                    <input type="number" name="season_id" value="{{ old('season_id') }}" min="1" class="fantasy-form-control" placeholder="Opcional">
                            ...
                            <div class="col-md-6">
                                <div class="fantasy-form-group">
                                    ...
                                    <div class="fantasy-checkbox-wrapper">
                                        ...
                                        <span>@lang('Bolão ativo')</span>
                                    </div>
                                    <small class="fantasy-form-help"><i class="las la-info-circle"></i> @lang('Desmarque para manter inativo')</small>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="fantasy-submit-footer">
                    <button type="submit" class="fantasy-submit-btn">
                        <i class="las la-save"></i> @lang('Criar Bolão')
                    </button>
                </div>
            </form>
        </div>
...
(function () {
    ...
    const createForm = document.getElementById('fantasyLeagueCreateForm');
    const createSubmitBtn = createForm ? createForm.querySelector('.fantasy-submit-btn') : null;
    const initialPrizeDistribution = @json(($oldPrizeDistribution = old('prize_distribution')) ? (json_decode($oldPrizeDistribution, true) ?: []) : []);
    const initialPhysicalPrizes = @json(old('physical_prizes', []));
    ...
    if (createForm) {
        createForm.addEventListener('submit', function(e) {
            ...
            if (createSubmitBtn) {
                ...
                createSubmitBtn.innerHTML = '<i class="las la-spinner la-spin"></i> Salvando...';
            }
        });
    }
    ...
    function syncDivisoes() {
        ...
        if (tem && Array.isArray(list) && list.length) {
            list.forEach(d => {
                ...
                if (String(@json(old('divisao'))) === String(d)) o.selected = true;
    ...
    function syncPricingUI(){
        ...
        if (houseHelp) {
            ...
            if (isPremium) {
                houseHelp.innerHTML = '<i class="las la-info-circle"></i> Não se aplica a bolão Premium (grátis).';
            } else if (isFree) {
                ...
                houseHelp.innerHTML = '<i class="las la-info-circle"></i> Para bolão pago: entre 20% e 50%';
            }
        }
    }
    ...
    rewardMode && rewardMode.addEventListener('change', function() {
        syncPricingUI();
        syncPrizeCalculation();
    });
    ...
    function validateManualPrizeBeforeSubmit() {
        ...
        const diffText = prizeDistributionInput.value;
        if (!diffText) {
