                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="SMS Sent From" name="sms_from" value="{{ gs('sms_from') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="4" placeholder="SMS Body" name="sms_template" required>{{ gs('sms_template') }}</textarea>
                            </div>
                        </div>
                    </div>
