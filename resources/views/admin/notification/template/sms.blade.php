...
@section('panel')
    <style>
        ...
        .fantasy-card {
            ...
            border: 1px solid rgba(59, 130, 246, 0.2); /* Azul para SMS */
            overflow: hidden;
            margin-bottom: 2rem;
        }
        
        .fantasy-header {
            background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); /* Azul para SMS */
            padding: 1.5rem 2rem;
            display: flex;
            ...
            <div class="fantasy-card">
                <div class="fantasy-header">
                    <h5 class="fantasy-title">
                        <i class="las la-mobile-alt"></i> Editando: {{ $template->name }}
                    </h5>
                    <div class="fantasy-nav">
                        ...
                        <a href="{{ route('admin.setting.notification.template.edit', ['sms', $template->id]) }}" class="fantasy-nav-btn active">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="fantasy-form-group">
                                <label class="fantasy-label">Remetente SMS</label>
                                <input type="text" class="fantasy-input" name="sms_sent_from" value="{{ $template->sms_sent_from }}">
                                <small>Deixe vazio para usar o nome global de envio de SMS.</small>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="fantasy-form-group">
                                ...
                                <input type="checkbox" data-height="46px" data-width="100%" data-onstyle="-success"
                                   ...
                                   data-off="Desativado" name="sms_status"
                        ...
                        <div class="col-md-12">
                            <div class="fantasy-form-group">
                                ...
                                <textarea name="sms_body" class="fantasy-input" placeholder="Sua mensagem usando short-codes" required>{{ $template->sms_body }}</textarea>
                            </div>
                        </div>
                    </div>
