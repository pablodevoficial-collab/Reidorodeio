        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Atualizar Extension: <span class="extension-name"></span></h5>
                ...
                <form method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn--primary w-100 h-45" id="editBtn">Enviar</button>
                    </div>
                </form>
            </div>
        </div>
