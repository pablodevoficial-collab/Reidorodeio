            ...
            <div class="col-md-12">
                <div class="card @if ($cron->logs->where('error', '!=', null)->count()) error-bg @endif">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex flex-lg-row flex-column justify-content-between gap-2">
                            <div class="flex-shrink-0 text-end d-flex align-items-start gap-2">
                                <a href="{{ route('admin.cron.schedule.logs', $cron->id) }}" class="btn btn-sm btn-outline--primary"><i class="las la-history"></i> Logs</a>

                                <a href="{{route('cron.manual.run', $cron->alias)}}" class="btn btn-sm btn-outline--success"><i class="las la-check-circle"></i> Executar agora</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            <small class="fw-bold text-muted">Comando: </small>
                            <small>
                        ...
                        <div>
                            <small class="fw-bold text-muted">Última execução: </small>
                        ...
                        <div>
                            <small class="fw-bold text-muted">Recomendação de intervalo: <span class="fw-semibold text--warning">{{ $cron->interval_info }}</span></small>
                        </div>
