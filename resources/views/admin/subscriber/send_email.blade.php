                            ...
                            <div class="card">
                                <div class="card-body p-5 text-center">
                                    <div class="coaling-loader flex-column d-flex justify-content-center">
                                        ...
                                        <p class="mt-2">
                                            E-mail will be sent again with a <span class="coaling-time-count"></span>
                                             second delay. Avoid closing or refreshing the browser.
                                        </p>
                                        <p class="text--primary">
                                             ' . @$sessionData['total_sent'] . ' out of ' . @$sessionData['total_subscriber'] . 'email were successfully transmitted
                                        </p>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" name="batch" value="{{ old('batch', @$sessionData['batch']) }}"
                                                    type="number" placeholder="How many subscriber" required>
