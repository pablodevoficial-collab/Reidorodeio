...
@section('panel')
    ...
    <div class="row mb-none-30">
        ...
        <div class="col-lg-9 col-md-9 mb-30">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title mb-4 border-bottom pb-2">Alterar Senha</h5>
                    ...
                    <form action="{{ route('admin.password.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <button type="submit" class="btn btn--primary w-100 btn-lg h-45">Enviar</button>
                    </form>
                </div>
            </div>
        </div>
...
@push('breadcrumb-plugins')
    <a href="{{route('admin.profile')}}" class="btn btn-sm btn-outline--primary" ><i class="las la-user"></i>Perfil Setting</a>
@endpush
@push('style')
    <style>
