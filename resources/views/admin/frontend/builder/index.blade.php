        ...
        <div class="col-6 col-lg-6 col-xl-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ __($pData->name) }} Page</h3>
                </div>

                <div class="card-body">
                    <div class="submitRequired bg--warning d-none form-change-alert"><i
                           class="fas fa-exclamation-triangle"></i>
                        You've to click on the Update Now button to apply the changes</div>
                    <form action="{{ route('admin.frontend.manage.section.update', $pData->id) }}" method="post">
                        ...
                        <button class="btn btn--primary w-100 h-45" type="submit">Atualizar Now</button>
                    </form>
                </div>
            </div>
        </div>
