                            ...
                            <div class="card">
                                <div class="card-body p-5 text-center">
                                    <div class="coaling-loader flex-column d-flex justify-content-center">
                                        ...
                                        <p class="mt-2">
                                            $viaText will be sent again with a <span class="coaling-time-count"></span>
                                             second delay. Avoid closing or refreshing the browser.
                                        </p>
                                        <p class="text--primary">
                                             ' . @$sessionData['total_sent'] . ' out of ' . @$sessionData['total_user'] . ' ' . $viaName . ' were successfully transmitted
                                        </p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="card">
                <form class="notify-form" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <small class="text--info d-none userCountText"> <i class="las la-info-circle"></i> <strong
                                            class="userCount">0</strong> active users found to send the notification</small>
                                </div>
                                    ...
                                    <div class="col-md-4 start-from-col">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="start" value="{{ old('start', @$sessionData['start']) }}"
                                                type="number" placeholder="Start form user id. e.g. 1" required>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" name="batch" value="{{ old('batch', @$sessionData['batch']) }}"
                                                    type="number" placeholder="How many user" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" name="cooling_time"
                                                    ...
                                                    placeholder="Waiting time" required>
                                                <span class="input-group-text">
                                                    Seconds
                                                </span>
                                            </div>
                    ...
                    <div class="card-footer">
                        <button class="btn w-100 h-45 btn--primary me-2" type="submit">Enviar</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            $('select[name=being_sent_to]').on('change', function(e) {
                ...
                if (methodName == 'SELECTEDUSERS') {
                    ...
                    <div class="form-group" id="user_list_wrapper">
                        <label class="required">Select Usuário</label>
